...
exports.deleteArticle = async function(id) {
 ...
 /**
 * Denne funktion henter/tæller data fra DB-tabellen articles 
 */
 ...
 * @param {Object} insertsObject - Placeholder object for LIMIT og OFFSET
 */
exports.showArticles = async function() {
    try {
        const articleSQL = `SELECT articles.id, articles.name, articles.content, articles.created_at, articles.fk_user
        FROM articles 
