 ...
 */
  ...
  /**
 * Denne funktion opdaterer data i DB-tabellen profiles
 * @param {Object} insertsObject - Placeholder object for kolonnerne email, id
 */
exports.updateProfile = async function(insertsObject) {
  ...
  /**
 * Denne funktion sletter data fra DB-tabellen profiles
